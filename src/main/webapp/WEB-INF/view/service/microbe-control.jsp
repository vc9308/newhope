...
<body>
  ...
  <article>
    <ul>
      <li>生产工艺过程：电子行业在生产过程中，因为微生物的存在，起到导电作用，使其产生不必要导体，造成微短，使产品的合格率降低。对此方面微生物的控制，可以减少和杜绝其微短和金属面氧化的问题。在金属加工行方面，可以减少水迹和氧化的问题。<br />&nbsp;
      <li>水处理方面：控制微生物，可以改少结垢和水质的改善。<br />&nbsp;
      <li>管路方面：因为管路的维护方面较难，一但产生微生物后，很难保证水质，后续处理或者更换比较难运作，在线微生物控制和清除，到达其运作的目的。<br />&nbsp;
      <li>设备维护方面：目前设备维护侧重于无机垢和有机垢，对微生物垢没有特别的重视，此方面不但有清洗的能力，同时要抑制后续的微生物的生长。<br />&nbsp;
      <li>提供全方面的微生物检测，配伍相应的微生物控制产品。<br />&nbsp;
    </ul>
  </article>
  <div class="footer">
